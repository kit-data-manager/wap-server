...
/**
 * This exception is used whenever a resource that already exists should be created
 * 
 ...
 * @version 1.1
 */
public class ResourceExistsException extends WapException {
   /**
   ...
   /**
    * Creates a new ResourceExistsException with a given message
    * 
    * @param message
    *                The message
    */
