...
/**
 * JSON-LD Formatter that can be used for JSON-LD Requests. It parses profiles from Accept and Content-Type strings and
 * applies them to the serialized output in {@link #format(FormattableObject)}.
 * 
...
public final class JsonLdFormatter extends AbstractFormatter {
   ...
   /**
    * This is a helper method necessary to be able to use a static URL, otherwise the exception can not be caught.
    * 
    * @param  urlString
    *                   The String to generate a URL from
   ...
   /**
    * Overloaded method to format annotation lists Single annotations are formatted as if they were annotations
    * directly, multiple ones have their own special array serialization
    * 
    * @param  annoList
    *                  The list to format
    ...
    * 
    * @param  jsonLdPretty
    *                      JSON-LD serialized in pretty mode
   ...
   private String applyProfiles(String jsonLd, String frameString) {
      try {
         ...
         if (frameObject != null) {
            ...
            final Map<String, Object> framed = JsonLdProcessor.frame(jsonObject, frameObject, options);
