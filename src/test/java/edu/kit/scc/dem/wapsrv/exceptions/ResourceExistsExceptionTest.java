...
/**
 * Tests the class ResourceExistsException
 * 
...
class ResourceExistsExceptionTest {
    ...
    */
   @Test
   final void testResourceExistsException() {
      ResourceExistsException actual;
      // test for all Strings in paramStringList
      for (String paramString : PARAMSTRINGLIST) {
         actual = null;
         actual = new ResourceExistsException(paramString);
