...
/**
 * Tests the class MethodNotAllowedException
 * 
...
class MethodNotAllowedExceptionTest {
    ...
    */
   @Test
   final void testMethodNotAllowedException() {
      MethodNotAllowedException actual;
      // test for all Strings in paramStringList
      for (String paramString : PARAMSTRINGLIST) {
         actual = null;
         actual = new MethodNotAllowedException(paramString);
