...
/**
 * Tests the class EtagDoesntMatchException
 * 
 ...
 * @version 1.1
 */
class EtagDoesntMatchExceptionTest {
    ...
    */
   @Test
   final void testEtagDoesntMatchException() {
      EtagDoesntMatchException actual;
      // test for all Strings in paramStringList
      for (String paramString : PARAMSTRINGLIST) {
         actual = null;
         actual = new EtagDoesntMatchException(paramString);
