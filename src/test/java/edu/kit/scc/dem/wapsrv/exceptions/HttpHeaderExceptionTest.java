...
/**
 * Tests the class HttpHeaderException
 * 
...
class HttpHeaderExceptionTest {
    ...
    */
   @Test
   final void testHttpHeaderException() {
      HttpHeaderException actual;
      // test for all Strings in paramStringList
      for (String paramString : PARAMSTRINGLIST) {
         actual = null;
         actual = new HttpHeaderException(paramString);
